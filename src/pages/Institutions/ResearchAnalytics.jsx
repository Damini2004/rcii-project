...
//   return (
//     <div className="min-h-screen bg-white font-sans text-[#0F172A] mt-[70px]">
//       {/* ── HERO ── */}
//       <section className="relative overflow-hidden bg-white min-h-[490px]">
...
//         />
//         {/* Content */}
//         <div className="relative z-20 max-w-[1500px] mx-auto px-8 lg:px-16 pt-8 pb-12">
//           {/* Breadcrumb */}
//           <div className="flex items-center gap-3 text-[12px] font-semibold mb-8">
//             <Link
//               to="/"
...
//               Research
//               <span className="bg-gradient-to-r from-[#563BFF] to-[#02AFC7] bg-clip-text text-transparent ml-3">
//                 Analytics
//               </span>
//             </h1>
...
//             <div className="flex flex-wrap gap-4 sm:mt-7 mt-4">
//               <button className="sm:mt-4 mt-3 bg-[#4F46E5] text-[14px] text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-[#4338CA] transition flex items-center gap-3">
//                 <BarChart2 size={17} />
//                 Request a Demo
//               </button>

//               <button className="sm:mt-4 mt-3 border border-[#4F46E5] text-[#4F46E5] text-[14px] px-6 py-3 rounded-md font-semibold hover:bg-indigo-50 transition flex items-center gap-3">
...
//       {/* ── WHY SECTION ── */}
//       <section className="bg-white px-4 sm:px-6 lg:px-8 -mt-10 relative z-30">
//         <div className="max-w-[1400px] mx-6 sm:mx-10 lg:mx-8">
//           <div className="bg-white rounded-xl shadow-[0_8px_30px_rgba(15,23,42,0.08)] border border-gray-100 px-5 sm:px-8 py-6 ">
...
//               ${index !== WHY_CARDS.length - 1 ? "lg:border-r border-gray-200" : ""}
//               ${index < WHY_CARDS.length - 1 ? "sm:border-r sm:odd:border-r" : ""}
//             `}
//                 >
//                   <div
//                     className={`w-[62px] h-[62px] rounded-full flex items-center justify-center mb-3 ${cardColors[index]?.bg}`}
//                   >
...
//                   <p className="text-[11px] sm:text-[12px] text-[#1f2937] leading-[1.7] max-w-[145px]">
//                     {desc}
//                   </p>
//                 </div>
//               ))}
...
//           {/* <div className="bg-white rounded-xl border border-gray-100 shadow-[0_8px_30px_rgba(15,23,42,0.06)] px-5 sm:px-7 py-4"> */}
//           <div className="text-center mb-5">
...
//                 <div
//                   key={title}
//                   className="bg-white rounded-xl border border-[#E7EAF3] px-5 py-5 shadow-sm hover:shadow-lg hover:border-[#C7D2FE] transition-all flex flex-col min-h-[270px]"
//                 >
//                   <div
//                     className={`w-[70px] h-[70px] rounded-full flex items-center justify-center mx-auto mb-4 ${colors.bg}`}
//                   >
...
//                   <button className="mt-5 flex items-center gap-2 text-[#4F46E5] text-[12px] font-semibold hover:gap-3 transition-all">
...
//         <div className="max-w-[1280px] mx-6 sm:mx-10 lg:mx-10">
//           <div className="bg-gradient-to-r from-[#563BFF] via-[#2466E8] to-[#009CA6] rounded-xl shadow-lg px-6 sm:px-10 py-6">
...
//                 <div
//                   key={title}
//                   className="bg-white rounded-xl border border-[#E7EAF3] px-4 py-5 shadow-sm hover:shadow-lg hover:border-[#C7D2FE] transition-all text-center min-h-[205px]"
//                 >
//                   <h3 className="text-[13px] font-extrabold text-[#07113F] mb-4">
//                     {title}
//                   </h3>

//                   <div className="h-[82px] flex items-center justify-center mb-4">
//                     <ChartComp />
//                   </div>
...
//       <section className="bg-white px-4 sm:px-6 lg:px-8 py-6">
//         <div className="max-w-[1280px] mx-6 sm:mx-10 lg:mx-10">
//           <div className="bg-gradient-to-r from-[#563BFF] via-[#2F57E5] to-[#0B8FA7] rounded-[14px] overflow-hidden px-6 lg:px-10 py-5">
...
//                   src={ctaImage}
//                   alt="Research Analytics"
//                   className="w-[180px] lg:w-[230px] object-contain"
//                 />
//               </div>
...
//                 <p className="text-white/90 text-[14px] lg:text-[13px] leading-relaxed max-w-[650px]">
...
//                 <button className="bg-white text-[#4F46E5] text-[13px] font-bold px-6 py-3 rounded-md hover:bg-gray-100 transition">
//                   Talk to an Expert →
//                 </button>

//                 <button className="border border-white text-white text-[13px] font-bold px-6 py-3 rounded-md hover:bg-white/10 transition">
//                   Schedule a Demo
//                 </button>
//               </div>
//             </div>
